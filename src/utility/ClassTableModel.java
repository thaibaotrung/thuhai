...
public class ClassTableModel {
    ...
    public DefaultTableModel setTableHocSinh(List<HocSinh> listHs, String[] listColumn) {
        ...
        Object[] obj;
        obj = new Object[columns];
        listHs.forEach((HocSinh item) -> {
                obj[0] = dtm.getRowCount() + 1;
                obj[1] = item.getIdNhanKhau();
                obj[2] = item.getHoTen();
                obj[3] = item.getNamSinh();
                dtm.addRow(obj);
        });
        return dtm;     
    }
